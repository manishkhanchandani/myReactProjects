  ...
  render() {
	return (
		<Router>
			...
			<Route exact={true} path="/results/:lat/:lng/:city/:state/:country/:location/:keyword"  component={Results} />
			<Route exact={true} path="/results/:lat/:lng/:city/:state/:country/:location"  component={Results} />
			<hr />
