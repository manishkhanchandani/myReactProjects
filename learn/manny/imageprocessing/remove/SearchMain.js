...
class Search extends Component {
	...
	render() {
		...
		let img = null;
		if (this.props.myReducer.image_name && this.props.myReducer.images && this.props.myReducer.images_highres[this.props.myReducer.image_name]) {
			img = this.props.myReducer.images_highres[this.props.myReducer.image_name];
		}
			...
			<div className="my-container container search fade-in">
				...
				<div className="row second-row text-center">
					<div className="col-md-12 sub-heading">
						<span>Send a photo via phone and say "Alexa process this image..."</span>	
					</div>
				</div>
						...
						<div className="row second-row text-center">
							{
								...
								<img src="/img/greenloaderBar2.gif" alt="loading1" />
							}
						</div>
					</div>
					<div className="col-md-6">
